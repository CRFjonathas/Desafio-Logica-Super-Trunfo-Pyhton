...
match opcao:
    ...
    case 2:
        print("\n>>> ÁREA <<<\n")
        print(f"CARTA 1 ({nome_1}): {area_1}")
        print(f"CARTA 2 ({nome_2}): {area_2}")
        print(f"\nCARTA {1 if area_1 > area_2 else 2} VENCEU!")

    case 3:
        print("\n>>> PIB <<<\n")
        print(f"CARTA 1 ({nome_1}): {pib_1}")
        print(f"CARTA 2 ({nome_2}): {pib_2}")
    ...
    case 5:
        ...
        print(f"CARTA 1 ({nome_1}): {densidade_populacional_1}")
        print(f"CARTA 2 ({nome_2}): {densidade_populacional_2}")
